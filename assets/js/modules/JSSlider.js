export default class JSSlider {
   constructor (imagesSelector) {
        ...
        this.navNext = this.sliderRootElement.querySelector('.js-slider__nav--next');
        this.navPrev = this.sliderRootElement.querySelector('.js-slider__nav--prev');
        this.zoom = this.sliderRootElement.querySelector('.js-slider__zoom');
        this.sliderProto = document.querySelector('.js-slider__thumbs-item.js-slider__thumbs-item--prototype');
    ...
    getCurrentImageAtr(e) {
        ...
        const currentSliderImage = this.sliderRootElement.querySelector('.js-slider__image');
    ...
    getCurrentImages (e) {
        ...
        const selectedGroupOfImages = getImages.filter(image => image.dataset.sliderGroupName === eventGroupName);
...
//   sliderStart() {
//     this.interval = setInterval(this.onImageNext, 1000)
//   }
//   sliderStop() {
//     this.interval = clearInterval(this.onImageNext)
//   }
}